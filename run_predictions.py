...
# The API key will be read securely from the GitHub secret
...
def get_gspread_client():
    ...
    # In an automated environment, the token.pickle must be valid and pre-generated.
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            print("Refreshing credentials...")
            creds.refresh(Request())
        else:
            print("Credentials not found or invalid. A valid token.pickle is required for automation.")
            return None
